...
const Home = () => {
  ...
  const handleMouseEnter = () => setIsHovered(true); // função chamada quando o mouse entra na área da imagem
  const handleMouseLeave = () => setIsHovered(false); // função chamada quando o mouse sai da área da imagem
  ...
  const imageInfo = {
    ...
    artist: 'Ticiano',
    year: '1576',
    description: 'This work is a replica of the picture which in 1515 was in the Gonzaga collection in Mantua and which is now in the Louvre. It is one of the finest works from Titians youth.',
  };
